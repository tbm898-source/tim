      ...
      <PullToRefresh onRefresh={handlePullToRefresh} className="pull-to-refresh-wrapper">
        ...
        <Tabs defaultValue="assets" className="space-y-6">
          ...
          <TabsContent value="maintenance">
            <Button disabled className="bg-gray-600 mb-4 cursor-not-allowed" title="Maintenance scheduling page coming soon">
              <Plus className="w-4 h-4 mr-2" />
          ...
          <TabsContent value="locations">
            <Button disabled className="bg-gray-600 mb-4 cursor-not-allowed" title="Location management page coming soon">
              <Plus className="w-4 h-4 mr-2" />
              Add Location
            </Button>
